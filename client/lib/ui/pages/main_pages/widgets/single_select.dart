...
class SingleSelectDialogField<V> extends FormField<V> {
  ...
  final List<SingleSelectItem<V>> items;
  ...
  SingleSelectDialogField({
    ...
    this.key,
            ...
            builder: (FormFieldState<V> state) {
              _SingleSelectDialogFieldView<V> field =
                  _SingleSelectDialogFieldView<V>(
                title: title,
                items: items,
              ...
              return _SingleSelectDialogFieldView<V>._withState(field, state);
            });
}

// ignore: must_be_immutable
class _SingleSelectDialogFieldView<V> extends StatefulWidget {
  final BoxDecoration? decoration;
  final Text? buttonText;
  final Icon? buttonIcon;
  final Widget? title;
  ...
  _SingleSelectDialogFieldView._withState(
      _SingleSelectDialogFieldView<V> field, FormFieldState<V> state)
      : items = field.items,
        title = field.title,
  ...
  @override
  __SingleSelectDialogFieldViewState createState() =>
      __SingleSelectDialogFieldViewState<V>();
}

class __SingleSelectDialogFieldViewState<V>
    extends State<_SingleSelectDialogFieldView<V>> {
  V? _selectedItem;
  ...
  @override
  void didUpdateWidget(_SingleSelectDialogFieldView<V> oldWidget) {
      ...
      builder: (ctx) {
        return SingleSelectDialog<V>(
          ...
          onConfirm: (selected) {
            ...
            if (widget.onConfirm != null) widget.onConfirm!(_selectedItem!);
          },
        );
      },
    );
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                widget.buttonText ?? const Text("Select category"),
                //rRR widget.buttonIcon ?? const Icon(Icons.arrow_downward),
              ],
            ),
          ),
        ),
...
class SingleSelectItem<T> {
  ...
  SingleSelectItem(this.value, this.label);
}
