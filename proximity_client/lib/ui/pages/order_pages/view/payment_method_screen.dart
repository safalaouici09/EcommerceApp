...
class PaymentMethodScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double total = productReservationTotal + productDeliveryTotal + productPickupTotal ; 
    final _paymentItems = [
      PaymentItem(
        label: 'Total',
        amount: '$total',
    ...
    var _controller = new TextEditingController(text: orderSliderValidation.expdate);
      ...
      Column(
            ...
            children: [
              ...
              EditText(
                ...
                onChanged:
                    orderSliderValidation.changecardNumber,
              ),
              SizedBox(height: 20),
              Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: EditText(
                      ...
                      keyboardType: TextInputType.number,
                      onChanged:
                          orderSliderValidation.changecvc,
                    ),
                  ),
                ],
              ),
              ...
              EditText(
                hintText :  "Name",
                onChanged:
                    orderSliderValidation.changename,
              ),
              SizedBox(height: 16),
              ...
              EditText(
                hintText :  "Phone",
                onChanged:
                    orderSliderValidation.changephone,
              ),
              SizedBox(height: 16),
              ...
              EditText(
                hintText :  "city",
                onChanged:
                    orderSliderValidation.changecity,
              ),
              SizedBox(height: 16),
              ...
              EditText(
                hintText :  "street",
                onChanged:
                    orderSliderValidation.changestreet,
              ),
              SizedBox(height: 16),
              ...
              EditText(
                hintText :  "street2",
                onChanged:
                    orderSliderValidation.changestreet2,
              ),
              SizedBox(height: 16),
              ...
              EditText(
                ...
                onChanged:
                    orderSliderValidation.changepostalCode,
              ),
              SizedBox(height: 16),
