            ...
            Column(children: [
              ...
              Expanded(
                ...
                EditText(
                  ...
                  onChanged:
                      storeCreationSliderValidation.changeStoreDescription,
                ),
                const InfoMessage(
                    message:
                ...
                EditText(
                  ...
                  saved: storeCreationSliderValidation
                      .storeRegistrationNumber.value,
                  errorText: storeCreationSliderValidation
                      .storeRegistrationNumber.error,
                  enabled: (widget.store.registrationNumber == null) ||
                      widget.editScreen,
                  onChanged: storeCreationSliderValidation
                      .changeStoreRegistrationNumber,
                ),
                ...
                Padding(
                  ...
                  child: ImagePickerWidget(
                      ...
                      onImageRemoved:
                          storeCreationSliderValidation.removeStoreImage),
                ),
                            ...
                            Padding(
                              ...
                              child: TertiaryButton(
                                onPressed: () {
                                  setState(() {
                                    storeCreationSliderValidation
                                        .addFixedWorkingHours(TimeRange(
                                  ...
                                  children: Day.map((day) {
                                    ...
                                    return Column(
                                      children: [
                                        ...
                                        if (storeCreationSliderValidation
                                            .selectedDays
                                            .contains(day))
                                          Padding(
                                            padding: const EdgeInsets.symmetric(
                ...
                EditText(
                  controller: () {
                    ...
                    _controller.text = storeCreationSliderValidation
                  ...
                  child: Column(
                    children: [
                      ListToggle(
                          ...
                          onToggle:
                              storeCreationSliderValidation.toggleGlobalPolicy),
                ...
                PrimaryButton(
                    ...
                    onPressed: () {
                      ...
                      if (widget.editScreen) {
                        FormData fm =
                            storeCreationSliderValidation.updateFormData(
                                storeCreationSliderValidation.policy!);
                        storeService.editStore(context, widget.index!, fm, []);
                      }
                    },
                    title: 'Confirm.')
              ])
